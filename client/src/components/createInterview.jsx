...
import {
    ...
    Target, Clock, BarChart3, Loader2
} from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="pt-4">
                            <button
                                ...
                                className="w-full px-4 py-3 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white font-medium rounded-lg transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                            >
                                {isSubmitting ? (
                                    <>
