...
const Footer = () => {
    return (
        <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-purple-50 via-purple-300/60 to-purple-50 mt-40">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><a href="/" className="hover:text-purple-600 transition">Careers</a></li>  {/* <span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span> */}
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    <p className="max-w-60">AI-powered mock interview platform built for every student’s success.</p>
                    <div className="flex items-center gap-4 mt-3">
                        <a href="https://www.instagram.com/" target="_blank" rel="noreferrer">
                            {/* I have removed the broken <circle> and <path> tags from here */}
                            <Instagram width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-dribbble size-5 hover:text-purple-500" aria-hidden="true"/>
                        </a>
                        <a href="https://linkedin.com/in/" target="_blank" rel="noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin size-5 hover:text-purple-500" aria-hidden="true">
                        ...
                        <a href="https://x.com/" target="_blank" rel="noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-twitter size-5 hover:text-purple-500" aria-hidden="true">
                                <path
                        ...
                        <a href="https://www.youtube.com" target="_blank" rel="noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-youtube size-6 hover:text-purple-500" aria-hidden="true">
                    ...
                    <p className="mt-3 text-center">© copyright @2025 hired.ai - Made with ❤️ in pune </p>
                </div>
            </footer>
        </>
    )
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        <a href="https://www.instagram.com/_amol.raut" target="_blank" rel="noreferrer">
                                <Instagram width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-dribbble size-5 hover:text-green-500" aria-hidden="true"/>
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="M19.13 5.09C15.22 9.14 10 10.44 2.25 10.94"></path>
                                <path d="M21.75 12.84c-6.62-1.41-12.14 1-16.38 6.32"></path>
                                <path d="M8.56 2.75c4.37 6 6 9.42 8 17.72"></path>
                        </a>
                        <a href="https://linkedin.com/in/amolraut9272" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://x.com/AmolRaut5580" target="_blank" rel="noreferrer">
