...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5 fill-purple-500" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-sm py-4 text-gray-800">hired.ai helped me land my dream job at Google. The AI feedback was incredibly detailed and helped me improve my communication skills significantly.</p>
        </div>
    );
