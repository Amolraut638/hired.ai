...
import { Plus, Clock, Target, BarChart3, Loader2, Trash2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-semibold text-gray-900">
                  {interviews.filter(i => i.status === 'scheduled' || i.status === 'in-progress').length}
                </p>
          ...
          {interviews.length === 0 ? (
            ...
            <div className="divide-y divide-gray-200">
              {interviews.map((interview) => (
                <div key={interview._id || interview.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="font-semibold text-gray-900">{interview.position}</h3>
                        <span className={`px-2.5 py-0.5 text-xs font-medium rounded-full ${interview.status === 'completed'
                    ...
                    <div className="flex items-center gap-3 ml-6">
                      <button
                        onClick={() => navigate(`/app/interview/${interview._id || interview.id}`)}
                      ...
                      {interview.status !== 'completed' && (
                        <button
                          onClick={() => navigate(`/app/start-interview/${interview._id || interview.id}`)}
